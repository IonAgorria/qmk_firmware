...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [LA_BASE]     = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LA_CU_BASE]  = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LA_CU_SHIFT] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LA_CU_ALTGR] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LA_KEYPAD]   = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LA_FN]       = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LA_CU_BASE] = LAYOUT_tkl_iso(
        ...
        _______,     KC_Q,        KC_W,        KC_L,        KC_P,        KC_G,        KC_J,        KC_F,        KC_U,        KC_Y,        KC_SCLN,     RA(KC_LBRC), RA(KC_RBRC),                _______,     _______,     _______,
        _______,     KC_A,        KC_S,        KC_D,        KC_T,        KC_E,        KC_R,        KC_N,        KC_O,        KC_I,        KC_H,        S(KC_COMM),  KC_MINS,       _______,
        C_LSCU,      RA(KC_GRV),  KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_K,        KC_M,        _______,     _______,     S(KC_7),                    C_RSCU,                   _______,
        _______,     _______,     _______,                                            _______,                                            _______,     _______,     _______,       _______,     _______,     _______,     _______
    ),

    [LA_CU_SHIFT] = LAYOUT_tkl_iso(
        S(KC_ESC),   S(KC_F1),    S(KC_F2),    S(KC_F3),    S(KC_F4),    S(KC_F5),    S(KC_F6),    S(KC_F7),    S(KC_F8),    S(KC_F9),    S(KC_F10),   S(KC_F11),     S(KC_F12),   _______,     S(KC_PSCR),  _______,     S(KC_PAUS),
        ...
        S(KC_TAB),   S(KC_Q),     S(KC_W),     S(KC_L),     S(KC_P),     S(KC_G),     S(KC_J),     S(KC_F),     S(KC_U),     S(KC_Y),     S(KC_SCLN),  RA(KC_QUOT), RA(KC_BSLS),                S(KC_DEL),   S(KC_END),   S(KC_PGDN),
        S(KC_CAPS),  S(KC_A),     S(KC_S),     S(KC_D),     S(KC_T),     S(KC_E),     S(KC_R),     S(KC_N),     S(KC_O),     S(KC_I),     S(KC_H),     S(KC_DOT),   S(KC_2),       S(KC_ENT),
        _______,     RA(KC_1),    S(KC_Z),     S(KC_X),     S(KC_C),     S(KC_V),     S(KC_B),     S(KC_K),     S(KC_M),     KC_NUBS,     S(KC_NUBS),  S(KC_MINS),                 _______,                  S(KC_UP),
        S(KC_LCTL),  S(KC_LGUI),  S(KC_LALT),                                         S(KC_SPC),                                          S(KC_RALT),  S(KC_RGUI),  S(KC_APP),     S(KC_RCTL),  S(KC_LEFT),  S(KC_DOWN),  S(KC_RGHT)
    ),

    [LA_CU_ALTGR] = LAYOUT_tkl_iso(
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,       _______,     _______,     _______,     _______,
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,       _______,     _______,     _______,     _______,
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     S(KC_QUOT),  RA(KC_SCLN),                _______,     _______,     _______,
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     KC_QUOT,     KC_LBRC,       _______,
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     S(KC_EQL),                  _______,                  _______,
        _______,     _______,     _______,                                            _______,                                            _______,     _______,     _______,       _______,     _______,     _______,     _______
    ),

    [LA_KEYPAD] = LAYOUT_tkl_iso(
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,       _______,     _______,     _______,     _______,
        ...
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     KC_KP_4,     KC_KP_5,     KC_KP_6,     KC_PENT,     _______,       _______,
        _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     _______,     KC_KP_1,     KC_KP_2,     KC_KP_3,                    _______,                  _______,
        _______,     _______,     _______,                                            _______,                                            KC_KP_0,     KC_KP_DOT,   KC_KP_ENTER,   _______,     _______,     _______,     _______
    ),
